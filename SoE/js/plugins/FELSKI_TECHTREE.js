...
var Felski = Felski || {};  
Felski.Techtree = {};
Felski.Techtree.version = 1.22;

/*:
* @plugindesc v1.2.2 A techtree plugin.
* @author Felski
* @help
...
* Plugin Commands
* ============================================================================
* You can directly open a tree by using plugin commands:
*  - TECHTREE [actorId]
...
Felski.Techtree.Lanes = Number(parameters['Lanes'] || 1);
Felski.Techtree.NoTreeText = String(parameters['No Skilltree Message Format']);
//Felski.Techtree.onMap = Boolean(parameters['onMap'] || false);
//Felski.Techtree.horizontal = Boolean(parameters['Horizontal Lanes'] || true);
...
//************************************************************************************************
    ...
    Game_Interpreter.prototype.pluginCommand = function(command, args) {
        ...
        if (command === 'ACTIVATENODE'){ // actor, tree uid, node uid
            $gameActors.actor(args[0]).activateNode(args[1], args[2]);
        }
...
//************************************************************************************************
    ...
    Game_Actor.prototype.onActivateTechtreeNode = function(technode) {
    	// Switches
...
//************************************************************************************************
    ...
    Game_Actor.prototype.activateNode = function(treeUid, nodeUid) {
            ...
            if(this._techtrees[i].uid === treeUid){
            	for (var j = 0; j < this._techtrees[i].nodes.length; j++) {
            		if(this._techtrees[i].nodes[j].technode.uid === nodeUid){
            			...
            			this.onActivateTechtreeNode(this._techtrees[i].nodes[j].technode);
            			return;
            		}
            	}
            }
...
//************************************************************************************************
    ...
    Scene_Techtree.prototype.prepare = function(actorId) {
    ...
    Scene_Techtree.prototype.createTechtreeWindow = function(){
        ...
        this._window_Techtree = new Window_Techtree(0, y, y, this._actor);
    ...
    Scene_Techtree.prototype.createTechtreeConfirmWindow = function(){
        this._window_TechtreeConfirm = new Window_Techtree_Confirm(this._actor, null);
...
//************************************************************************************************
    ...
    Window_Techtree.prototype.initialize = function(x, y, h2, actor) {
...
//************************************************************************************************
    ...
    Window_Techtree_Confirm.prototype.initialize = function(actor) {
	...
	Window_Base.prototype.drawTextAutoWrap = function (text, x, y, maxWidth) {
	    ...
	    words.forEach((word) => {
	        ...
	        if(word.match(iconRegex)){
	        	...
	        	x2 = x2 + Window_Base._iconWidth + this.standardPadding();
	        	return;
	        }
	        if (x2 + width >= maxWidth) {
	            lines++;
