...
(function ($) {
  ...
  Game_Unit.prototype.initMenuCommands = function() {
    ...
    if (cmds[3]) {
      this.addMenuCommand_class()
    }
    if (cmds[4]) {
      this.addMenuCommand_statAllocate()
    }
    if (cmds[5]) {
      this.addMenuCommand_status()
    }
    if (cmds[6]) {
      this.addMenuCommand_row()
    }
    if (cmds[7]) {
      this.addMenuCommand_bestiary()
    }
    if (cmds[8]) {
      this.addMenuCommand_quest()
    }
    this.addMenuCommand_options();
    if (cmds[9]) {
      this.addMenuCommand_musicMenu()
    }
    if (cmds[10]) {
      this.addMenuCommand_credits()
    }
  ...
  Game_Unit.prototype.addMenuCommand_item = function() {
    var command = new Data_MenuCommand("item", "Inventory");
    this.addMenuCommand(command);
  };
  
  Game_Unit.prototype.addMenuCommand_class = function() {
    var command = new Data_MenuCommand("class", Yanfly.Param.CCCCmdName);
    this.addMenuCommand(command);
  };

  Game_Unit.prototype.addMenuCommand_statAllocate = function() {
    var command = new Data_MenuCommand("statAllocate", Yanfly.Param.StatAlcCmdName);
    this.addMenuCommand(command);
  };
  ...
  Game_Unit.prototype.addMenuCommand_row = function() {
    var command = new Data_MenuCommand("row", Yanfly.Param.RowCmdName);
    this.addMenuCommand(command);
  };

  Game_Unit.prototype.addMenuCommand_bestiary = function() {
    var command = new Data_MenuCommand("common event", "Bestiary");
    this.addMenuCommand(command);
  };

  Game_Unit.prototype.addMenuCommand_quest = function() {
    var command = new Data_MenuCommand("quest", "Quest");
    this.addMenuCommand(command);
  };
  ...
  Game_Unit.prototype.addMenuCommand_musicMenu = function() {
    var command = new Data_MenuCommand("musicMenu", "Music Menu");
    this.addMenuCommand(command);
  };

  Game_Unit.prototype.addMenuCommand_credits = function() {
    var command = new Data_MenuCommand("credits", "Credits");
    this.addMenuCommand(command);
  };
  
  Game_Unit.prototype.addMenuCommand_gameEnd = function() {
    var command = new Data_MenuCommand("common event 2", "To Title");
    this.addMenuCommand(command);
  };
  ...
  Window_MenuCommand.prototype.addCommand_class = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };

  Window_MenuCommand.prototype.addCommand_statAllocate = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };
  ...
  Window_MenuCommand.prototype.addCommand_row = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };
  
  Window_MenuCommand.prototype.addCommand_bestiary = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };
  
  Window_MenuCommand.prototype.addCommand_quest = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };
  ...
  Window_MenuCommand.prototype.addCommand_musicMenu = function(cmd) {
    var enabled = this.areMainCommandsEnabled();
    this.addCommand(cmd.name, cmd.symbol, cmd.isEnabled() && enabled);
  };
  
  Window_MenuCommand.prototype.addCommand_credits = function(cmd) {
